Public Class SpinningProgress
    ...
    Property AutoIncrement() As Boolean
        ...
        Set(ByVal value As Boolean)
            ...
            If value = False AndAlso Not m_AutoRotateTimer Is Nothing Then
...
#End Region
    ...
    Private Sub SpinningProgress_EnabledChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.EnabledChanged
    ...
    Private Sub ProgressDisk_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles MyBase.Paint
